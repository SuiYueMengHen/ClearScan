...
interface InferenceEngine {
     ...
     *
     * @throws java.io.IOException if the GGUF file cannot be loaded
     */
    suspend fun loadModel(pathToModel: String)

    /** Returns native backend diagnostics without loading a model. */
    ...
    /** Clears previous chat turns while keeping the model loaded. */
